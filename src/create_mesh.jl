...
function propagate_poisson(
    ...
    ϕ2 = zeros(Float64, size(ϕ))
    @. ϕ2[1:N_Pixel_Height, 1:N_Pixel_Width] = ϕ[1:N_Pixel_Height, 1:N_Pixel_Width] + ω_clamped * δ[1:N_Pixel_Height, 1:N_Pixel_Width]
    @assert !any(isnan.(ϕ2)) """
